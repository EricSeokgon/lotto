...
@router.get("/stats/multiples-5")
async def multiples5_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-145: 5의 배수 분포 분석."""
    data = wd.get_multiples5_analysis()
    return _render(request, "multiples5.html", {
        "active_tab": "multiples5",
        "data": data,
    })


@router.get("/stats/multiples-7")
async def multiples7_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-146: 7의 배수 분포 분석."""
    data = wd.get_multiples7_analysis()
    return _render(request, "multiples7.html", {
        "active_tab": "multiples7",
        "data": data,
    })


@router.get("/stats/multiples-11")
async def multiples11_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-147: 11의 배수 분포 분석."""
    data = wd.get_multiples11_analysis()
    return _render(request, "multiples11.html", {
        "active_tab": "multiples11",
        "data": data,
    })


@router.get("/stats/multiples-13")
async def multiples13_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-148: 13의 배수 분포 분석."""
    data = wd.get_multiples13_analysis()
    return _render(request, "multiples13.html", {
...
@router.get("/stats/multiples-19")
async def multiples19_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-150: 19의 배수 분포 분석."""
    data = wd.get_multiples19_analysis()
    return _render(request, "multiples19.html", {
        "active_tab": "multiples19",
        "data": data,
    })


@router.get("/stats/multiples-23")
async def multiples23_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-151: 23의 배수 분포 분석."""
    data = wd.get_multiples23_analysis()
    return _render(request, "multiples23.html", {
        "active_tab": "multiples23",
        "data": data,
    })


@router.get("/stats/multiples-29")
async def multiples29_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-152: 29의 배수 분포 분석."""
    data = wd.get_multiples29_analysis()
    return _render(request, "multiples29.html", {
        "active_tab": "multiples29",
        "data": data,
    })


@router.get("/stats/multiples-31")
async def multiples31_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-153: 31의 배수 분포 분석."""
    data = wd.get_multiples31_analysis()
    return _render(request, "multiples31.html", {
        "active_tab": "multiples31",
        "data": data,
    })


@router.get("/stats/multiples-37")
async def multiples37_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-154: 37의 배수 분포 분석."""
    data = wd.get_multiples37_analysis()
    return _render(request, "multiples37.html", {
        "active_tab": "multiples37",
        "data": data,
    })


@router.get("/stats/multiples-41")
async def multiples41_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-155: 41의 배수 분포 분석."""
    data = wd.get_multiples41_analysis()
    return _render(request, "multiples41.html", {
        "active_tab": "multiples41",
        "data": data,
    })


@router.get("/stats/multiples-43")
async def multiples43_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-156: 43의 배수 분포 분석."""
    data = wd.get_multiples43_analysis()
    return _render(request, "multiples43.html", {
...
@router.get("/stats/perfect-cube")
async def perfect_cube_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-159: 세제곱수 분포 분석."""
    data = wd.get_perfect_cube_analysis()
    return _render(request, "perfect_cube.html", {
...
async def sum_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-169: 번호 합계 분포 분석."""
    data = wd.get_sum_analysis()
    return _render(request, "sum_dist.html", {
        "active_tab": "sum_dist",
        "data": data,
    })
...
@router.get("/stats/hexagonal")
async def hexagonal_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-177: 육각수 포함 분포 분석."""
    data = wd.get_hexagonal_analysis()
    return _render(request, "hexagonal.html", {
        "active_tab": "hexagonal",
        "data": data,
    })


@router.get("/stats/heptagonal")
async def heptagonal_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-178: 칠각수 포함 분포 분석."""
    data = wd.get_heptagonal_analysis()
    return _render(request, "heptagonal.html", {
...
@router.get("/stats/hendecagonal")
async def hendecagonal_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-182: 십일각수 포함 분포 분석."""
    data = wd.get_hendecagonal_analysis()
    return _render(request, "hendecagonal.html", {
...
@router.get("/stats/tridecagonal")
async def tridecagonal_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-184: 십삼각수 포함 분포 분석."""
    data = wd.get_tridecagonal_analysis()
    return _render(request, "tridecagonal.html", {
...
@router.get("/stats/pentadecagonal")
async def pentadecagonal_page(request: Request) -> TemplateResponse:
    """SPEC-LOTTO-186: 십오각수 포함 분포 분석."""
    data = wd.get_pentadecagonal_analysis()
    return _render(request, "pentadecagonal.html", {
